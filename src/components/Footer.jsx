...
function Footer() {
    return (
        <footer className="dark:!bg-gray-900 text-gray-600 dark:text-gray-400 body-font">
            <div className="container px-4 py-4 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 lg:mt-auto">© 2020 Tailblocks —
